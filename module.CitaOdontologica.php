...
header ("Location: index.php?menu=26&ErrorCaptcha=1");
...
$para  = 'odontologiabeta@gmail.com' . ', '; // atención a la coma
$para .= 'informacionhospitalbetania@gmail.com';

// titulo

$tit = 'Solicitud Cita Odontológica';
...
<body> 
<h1>Solicitud de Cita Odontológica de '.$nombre .'</h1> 
<p> 
</p>
<p>
	<ul>
...
header ("Location: index.php?menu=26&Estado=1");
