...
<section class="section-title">
	<div class="container">
			<h3>Solicitud Cita Odontológica</h3>
	</div>
</section>
	...
	<div class="row">
		...
		?>
			...
			<div class="alert alert-success alert-dismissable">
				...
				<strong>Gracias</strong> Su Solicitud de Cita Odontológica Fue Enviada con Éxito.</strong>
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-6">
			...
			<div class="page-header">
					<h3>Cita Odontológica. <small>Formulario de Solicitud de Cita Odontológica</small></h3>
			</div>


			<p>Por medio del siguiente formulario usted podra soliciar una Cita Odontológica
			...
			<p class="lead">Tambien puede soliciar su Cita Odontológica al teléfono 843 50 50 ext 107</p>
		...
		<div class="col-lg-6 col-md-6">
			...
			<form role="form" name="formCitaOdontologica" id="formCitaOdontologica" method="post" action="module.CitaOdontologica.php">
