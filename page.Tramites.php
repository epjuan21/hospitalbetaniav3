	...
	<div class="row">
		...
		<div class="col-xs-12">
			<div class="page-header">
				<h3>Trámites ESE Hospital San Antonio</h3>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-xs-12">
			...
			<div class="panel panel-default">
				...
				ESE Hospital San Antonio, ya sea para cumplir con una obligación,
				obtener un beneficio o servicio o, en general.
				</div>
			</div>

			<div class="panel panel-default">
				<div class="panel-heading">Que trámites puedo realizar en la ESE Hospital San Antonio?</div>
				<div class="panel-body">
					<ul>
						<li>Solicitud de Citas (Consulta Externa, Odontología, Higiene Oral, Crecimiento y Desarrollo, Programas de Prevención y Promoción)</li>
						<li>Solicitud Copia de Historia Clínica</li>
						<li>Solicitud de Información</li>
						<li>Sugerencias, Quejas, reclamos, felicitaciones</li>
					</ul>
				</div>
			</div>
